...
static bfd_reloc_code_real_type
elf64_aarch64_bfd_reloc_from_type (unsigned int r_type)
{
...
elf64_aarch64_howto_from_type (unsigned int r_type)
{
  ...
  val = elf64_aarch64_bfd_reloc_from_type (r_type);
		  ...
		  bfd_vma offset, bfd_vma value)
{
  ...
  r_type = elf64_aarch64_bfd_reloc_from_type (r_type);
			...
			unsigned long r_symndx)
{
  bfd_reloc_code_real_type bfd_r_type
    = elf64_aarch64_bfd_reloc_from_type (r_type);
			 ...
			 Elf_Internal_Rela *rel, struct elf_link_hash_entry *h)
{
  ...
  switch (elf64_aarch64_bfd_reloc_from_type (r_type))
    {
    case BFD_RELOC_AARCH64_TLSDESC_ADR_PAGE21:
    case BFD_RELOC_AARCH64_TLSGD_ADR_PAGE21:
      if (is_local)
  ...
  for (; rel < relend; rel++)
    {
      ...
      howto = bfd_reloc.howto = elf64_aarch64_howto_from_type (r_type);
