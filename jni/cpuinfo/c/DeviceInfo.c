...
JNIEXPORT jobject JNICALL Java_DeviceInfo_GetCpuInfo(JNIEnv *env, jobject obj)
{
    ...
    jclass cls = (*env)->FindClass(env, "CpuInfo");
 ...
 * Signature: ()LNetInfo;
 */
JNIEXPORT jobject JNICALL Java_DeviceInfo_GetNetInfo(JNIEnv *env, jobject obj)
{
    char mac[20] = {0};
    char ip[20] = {0};
    ...
    jclass cls = (*env)->FindClass(env, "NetInfo");
    jmethodID id = (*env)->GetMethodID(env, cls, "<init>", "()V");
    jobject paramout = (*env)->NewObjectA(env, cls, id, 0);
...
JNIEXPORT jobject JNICALL Java_DeviceInfo_GetDiskInfo(JNIEnv *env, jobject obj)
{
    ...
    for(int j = 0; j < i; j++)
    {
        jclass disk_cls = (*env)->FindClass(env, "DiskInfo");
 ...
 * Signature: ()LSysInfo;
 */
JNIEXPORT jobject JNICALL Java_DeviceInfo_GetSysInfo(JNIEnv *env, jobject obj)
{
    char* sys_type = "Linux";
    ...
    jclass sys_cls = (*env)->FindClass(env, "SysInfo");
